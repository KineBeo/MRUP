...
SQLite không hỗ trợ RANGE frame khi ORDER BY có nhiều hơn một cột [https://sqlite.org/windowfunctions.html]. Điều này xuất phát từ độ phức tạp trong việc xác định "khoảng cách" giữa các hàng khi có nhiều cột sắp xếp. Ví dụ vi phạm:
