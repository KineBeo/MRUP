...
\begin{thebibliography}{xx}
	...
	\harvarditem[Rigger \harvardand\ Su]{Rigger \harvardand\ Su}{2020}{Rigger2020}
	Manuel Rigger \harvardand\ Zhendong Su, ``{Testing Database Engines via Pivoted Query Synthesis}'',
	{\em 14th USENIX Symposium on Operating Systems Design and Implementation (OSDI 20)}, 2020, pp.~667--682.
	
	\harvarditem[Rigger \harvardand\ Su]{Rigger \harvardand\ Su}{2020}{Rigger2020TLP}
	Manuel Rigger \harvardand\ Zhendong Su, ``{Detecting Optimization Bugs in Database Engines via Non-Optimizing Reference Engine Construction}'',
	{\em Proceedings of the 28th ACM Joint Meeting on European Software Engineering Conference and Symposium on the Foundations of Software Engineering (ESEC/FSE)}, 2020, pp.~1140--1152.
	
	\harvarditem[Rigger \harvardand\ Su]{Rigger \harvardand\ Su}{2020}{Rigger2020NoREC}
	Manuel Rigger \harvardand\ Zhendong Su, ``{Finding Bugs in Database Systems via Query Partitioning}'',
	{\em Proceedings of the ACM on Programming Languages}, vol.~4, no.~OOPSLA, 2020, pp.~1--30.
	
	\harvarditem[Rigger \harvardand\ Su]{Rigger \harvardand\ Su}{2020}{Rigger2020SQLancer}
	Manuel Rigger \harvardand\ Zhendong Su, ``{SQLancer: Finding Logic Bugs in Database Management Systems}'',
	{\em SQLancer GitHub Repository}, 2020.
	\newline{[Online]. Available: $https://github.com/sqlancer/sqlancer$}
